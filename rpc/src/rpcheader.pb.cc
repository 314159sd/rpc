...
const uint32_t TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::RpcHeader, _impl_.service_name_),
  PROTOBUF_FIELD_OFFSET(::fixbug::RpcHeader, _impl_.method_name_),
  PROTOBUF_FIELD_OFFSET(::fixbug::RpcHeader, _impl_.arg_size_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::fixbug::RpcHeader)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::fixbug::_RpcHeader_default_instance_._instance,
};

const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcheader.proto\022\006fixbug\"H\n\tRpcHeader\022\024"
...
RpcHeader::RpcHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:fixbug.RpcHeader)
}
...
template<> PROTOBUF_NOINLINE ::fixbug::RpcHeader*
Arena::CreateMaybeMessage< ::fixbug::RpcHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::RpcHeader >(arena);
}
